...
def OpencvDemo093():
    ...
    face_detector = cv.CascadeClassifier("models/lbpcascade_frontalface_improved.xml")

    winName = "LBP cascade classifiers"
    ...
    while True:
        ...
        faces = face_detector.detectMultiScale(src, scaleFactor=1.2, minNeighbors=1,
